...
namespace SportHalls.StrategyPattern.Tests.Inventor
{
    public class TennisInventorUnitTests
    {
        ...
        {
            IRentable racket = new RentStrategy.InventorRent.Inventor(new TennisRacketRentStrategy());
        ...
        {
            IRentable balls = new RentStrategy.InventorRent.Inventor(new TennisBallsRentStrategy());
        ...
        {
            IRentable machine = new RentStrategy.InventorRent.Inventor(new TennisBallsMachineRentStrategy());
